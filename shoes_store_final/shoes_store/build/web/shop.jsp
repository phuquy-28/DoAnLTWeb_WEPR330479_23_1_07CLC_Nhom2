            ...
            <form action="loadbyprice" method="post">
                <div class="col item">
                    <div class="form-check">
                        <input class="form-check-input rounded-0 custom-control-input" type="checkbox" name="priceRange" value="under100" id="under100">
                        <label class="form-check-label" for="under100">
                            Under 100$
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input rounded-0 custom-control-input" type="checkbox" name="priceRange" value="100to200" id="100to200">
                        <label class="form-check-label" for="100to200">
                            100$ - 200$
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input rounded-0 custom-control-input" type="checkbox" value="200to300" id="200to300">
                        <label class="form-check-label" for="200to300">
                            200$ - 300$
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input rounded-0 custom-control-input" type="checkbox" value="300to400" id="300to400">
                        <label class="form-check-label" for="300to400">
                            300$ - 400$
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input rounded-0 custom-control-input" type="checkbox" value="400plus" id="400plus">
...
<!--            <div>${productCount}</div>
            ...
            <div class="row"> 
                ...
                <!--<div>${indexPage}</div>-->
                <!--<div>${endPage}</div>-->
                <c:forEach items="${listShoes}" var="o" varStatus="loop">
